...
#ifndef POINTCLOUDREGISTRATION_SRC_REGISTRATION_BENCHMARK_BM_IA_KFPCS_H_
#define POINTCLOUDREGISTRATION_SRC_REGISTRATION_BENCHMARK_BM_IA_KFPCS_H_
...
void BM_EFFICIENCY_IA_KFPCS(benchmark::State& state)
{
  QFile saveBenchMarkTest("BM_IA_KFPCS.csv");
...
void BM_ACCURACY_IA_KFPCS(benchmark::State& state)
{
  for (auto _ : state) {
    QFile saveBenchMarkTest("BM_ACCURACY_IA_KFPCS.csv");
    if (saveBenchMarkTest.open(QIODevice::Append | QIODevice::Text)) {
...
#endif // POINTCLOUDREGISTRATION_SRC_REGISTRATION_BENCHMARK_BM_IA_KFPCS_H_
